...
if ($marketid != "") 
{
	...
	$milliseconds = 1000 * strtotime($result["return"][0]["datetime"]);
	$tradeonethousand = 1000 * strtotime($result["return"][999]["datetime"]);
	$tradeone = 1000 * strtotime($result["return"][0]["datetime"]);
	$timelaspe = $tradeone - $tradeonethousand;
	$minlaspe = ($timelaspe / 1000);
