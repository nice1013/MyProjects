...
/// begin variables
int sleepPin = 5;  /// - int sleepPin: number indicating to which pin the sleep port is attached. DIGITAL OUT
int selfTestPin = 6;/// - int selfTestPin: number indicating to which pin the selftest port is attached. DIGITAL OUT
int zeroGPin = 2;/// - int zeroGPin: number indicating to which pin the ZeroGpin is connected to. DIGITAL IN
gSelectPin = 11;/// - int gSelectPin: number indication to which pin the Gselect is connected to. DIGITAL OUT
int xPin = 5; /// - int xPin: number indicating to which pin the x-axis pin is connected to. ANALOG IN
int yPin = 4; /// - int yPin: number indicating to which pin the y-axis  pin is connected to. ANALOG IN
int zPin = 3;/// - int zPin: number indicating to which pin the z-axis  pin is connected to. ANALOG IN
int offset = 0;/// - int offset: array indicating the G offset on the x,y and z-axis
